...
public class CurvatureDrive extends CommandBase {
   ...
   */
  public CurvatureDrive(DriveSubsystem drive, LimelightSubsystem limelight, double power, double rotation) {
    this.drive = drive;
  ...
  public void execute() {
    ...
    if(drive.driveStick.getRawButton(8)){ /** IF ROBOT IS NOT MEANT TO SNAP TO TARGET */
      drive.curvatureDrive(drive.driveStick.getRawAxis(1), x * kP);
